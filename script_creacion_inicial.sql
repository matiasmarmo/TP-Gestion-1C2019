...
GO
ALTER TABLE [ZAFFA_TEAM].[Reserva]  WITH CHECK ADD  CONSTRAINT [FK_Reserva_Pasaje] FOREIGN KEY([PASAJE_CODIGO])
REFERENCES [ZAFFA_TEAM].[Pasaje] ([PASAJE_CODIGO])
GO
ALTER TABLE [ZAFFA_TEAM].[Reserva] CHECK CONSTRAINT [FK_Reserva_Pasaje]
GO
...
AS
BEGIN
INSERT INTO ZAFFA_TEAM.Reserva(RESERVA_FECHA,CLI_ID,VIAJE_ID,CRUCERO_ID,
CABINA_NRO,CABINA_PISO)
VALUES (GETDATE(),@CLI_ID,@VIAJE_ID,@CRUCERO_ID,@CABINA_NRO,@CABINA_PISO)
END
GO
