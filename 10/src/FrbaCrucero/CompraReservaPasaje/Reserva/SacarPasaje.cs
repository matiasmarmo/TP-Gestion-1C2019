    ...
    public partial class SacarPasaje : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (fecha_salida == "" && fecha_llegada != "" && PUERTO_ORIGEN.Text == "" && PUERTO_DESTINO.Text == "")
            {
                ...
                String a = "select distinct a.VIAJE_ID, a.Crucero_ID from ZAFFA_TEAM.Viaje a join ZAFFA_TEAM.Tramo b on a.RECORRIDO_CODIGO = b.RECORRIDO_CODIGO join ZAFFA_TEAM.Puerto c on b.PUERTO_DESDE_ID = c.PUERTO_ID join ZAFFA_TEAM.Puerto d on b.PUERTO_HASTA_ID = d.PUERTO_ID join ZAFFA_TEAM.Recorrido_Unico e on e.RECORRIDO_CODIGO = a.RECORRIDO_CODIGO where a.FECHA_SALIDA > '" + date.ToString("yyyy-MM-dd") + "' and a.FECHA_LLEGADA LIKE '" + fecha_llegada + "%' and e.ESTADO_RECORRIDO = 'A' ";
                String b = " order by VIAJE_ID ";
            ...
            if (fecha_salida == "" && fecha_llegada == "" && PUERTO_ORIGEN.Text == "" && PUERTO_DESTINO.Text == "")
            {
                String a = "select distinct a.VIAJE_ID, a.Crucero_ID from ZAFFA_TEAM.Viaje a join ZAFFA_TEAM.Tramo b on a.RECORRIDO_CODIGO = b.RECORRIDO_CODIGO join ZAFFA_TEAM.Puerto c on b.PUERTO_DESDE_ID = c.PUERTO_ID join ZAFFA_TEAM.Puerto d on b.PUERTO_HASTA_ID = d.PUERTO_ID join ZAFFA_TEAM.Recorrido_Unico e on e.RECORRIDO_CODIGO = a.RECORRIDO_CODIGO where a.FECHA_SALIDA > '" + date.ToString("yyyy-MM-dd") + "' and e.ESTADO_RECORRIDO = 'A' ";
                String b = " order by VIAJE_ID ";
            ...
            if (fecha_salida != "" && fecha_llegada != "" && PUERTO_ORIGEN.Text == "" && PUERTO_DESTINO.Text == "")
            {
                fecha_salida = Convert.ToDateTime(fecha_salida).ToString("yyyy-MM-dd");
                fecha_llegada = Convert.ToDateTime(fecha_llegada).ToString("yyyy-MM-dd");
                String a = "select distinct a.VIAJE_ID, a.Crucero_ID from ZAFFA_TEAM.Viaje a join ZAFFA_TEAM.Tramo b on a.RECORRIDO_CODIGO = b.RECORRIDO_CODIGO join ZAFFA_TEAM.Puerto c on b.PUERTO_DESDE_ID = c.PUERTO_ID join ZAFFA_TEAM.Puerto d on b.PUERTO_HASTA_ID = d.PUERTO_ID join ZAFFA_TEAM.Recorrido_Unico e on e.RECORRIDO_CODIGO = a.RECORRIDO_CODIGO where a.FECHA_SALIDA like '" + fecha_salida + "%' and a.FECHA_LLEGADA like '" + fecha_llegada + "%' and e.ESTADO_RECORRIDO = 'A' ";
                String b = " order by VIAJE_ID ";
            ...
            if (fecha_salida == "" && fecha_llegada == "" && PUERTO_ORIGEN.Text != "" && PUERTO_DESTINO.Text == "")
            {
                String a = "(select a.VIAJE_ID, a.Crucero_ID from ZAFFA_TEAM.Viaje a join ZAFFA_TEAM.Tramo b on a.RECORRIDO_CODIGO = b.RECORRIDO_CODIGO join ZAFFA_TEAM.Puerto c on b.PUERTO_DESDE_ID = c.PUERTO_ID join ZAFFA_TEAM.Puerto d on b.PUERTO_HASTA_ID = d.PUERTO_ID join ZAFFA_TEAM.Recorrido_Unico e on e.RECORRIDO_CODIGO = a.RECORRIDO_CODIGO where a.FECHA_SALIDA >= '" + fecha_actual + "'  and e.ESTADO_RECORRIDO = 'A' )";
                String b = "(select a.VIAJE_ID, a.Crucero_ID from ZAFFA_TEAM.Viaje a join ZAFFA_TEAM.Tramo b on a.RECORRIDO_CODIGO = b.RECORRIDO_CODIGO join ZAFFA_TEAM.Puerto c on b.PUERTO_DESDE_ID = c.PUERTO_ID join ZAFFA_TEAM.Puerto d on b.PUERTO_HASTA_ID = d.PUERTO_ID join ZAFFA_TEAM.Recorrido_Unico e on e.RECORRIDO_CODIGO = a.RECORRIDO_CODIGO where c.NOMBRE_PUERTO like '" + PUERTO_ORIGEN.Text + "%' and b.ORDEN_TRAMOS = 1  and e.ESTADO_RECORRIDO = 'A' )";
                String c = "(select a.VIAJE_ID, a.Crucero_ID from ZAFFA_TEAM.Viaje a join ZAFFA_TEAM.Tramo b on a.RECORRIDO_CODIGO = b.RECORRIDO_CODIGO join ZAFFA_TEAM.Puerto c on b.PUERTO_DESDE_ID = c.PUERTO_ID join ZAFFA_TEAM.Puerto d on b.PUERTO_HASTA_ID = d.PUERTO_ID join ZAFFA_TEAM.Recorrido_Unico e on e.RECORRIDO_CODIGO = a.RECORRIDO_CODIGO where d.NOMBRE_PUERTO like '" + PUERTO_DESTINO.Text + "%'  and e.ESTADO_RECORRIDO = 'A' )";
            ...
            {
                fecha_llegada = Convert.ToDateTime(fecha_llegada).ToString("yyyy-MM-dd");
                String a = "(select a.VIAJE_ID, a.Crucero_ID from ZAFFA_TEAM.Viaje a join ZAFFA_TEAM.Tramo b on a.RECORRIDO_CODIGO = b.RECORRIDO_CODIGO join ZAFFA_TEAM.Puerto c on b.PUERTO_DESDE_ID = c.PUERTO_ID join ZAFFA_TEAM.Puerto d on b.PUERTO_HASTA_ID = d.PUERTO_ID join ZAFFA_TEAM.Recorrido_Unico e on e.RECORRIDO_CODIGO = a.RECORRIDO_CODIGO where a.FECHA_SALIDA >= '" + fecha_actual + "' and a.FECHA_LLEGADA like '" + fecha_llegada + "%'  and e.ESTADO_RECORRIDO = 'A' )";
                String b = "(select a.VIAJE_ID, a.Crucero_ID from ZAFFA_TEAM.Viaje a join ZAFFA_TEAM.Tramo b on a.RECORRIDO_CODIGO = b.RECORRIDO_CODIGO join ZAFFA_TEAM.Puerto c on b.PUERTO_DESDE_ID = c.PUERTO_ID join ZAFFA_TEAM.Puerto d on b.PUERTO_HASTA_ID = d.PUERTO_ID join ZAFFA_TEAM.Recorrido_Unico e on e.RECORRIDO_CODIGO = a.RECORRIDO_CODIGO where c.NOMBRE_PUERTO like '" + PUERTO_ORIGEN.Text + "%' and b.ORDEN_TRAMOS = 1  and e.ESTADO_RECORRIDO = 'A' )";
                String c = "(select a.VIAJE_ID, a.Crucero_ID from ZAFFA_TEAM.Viaje a join ZAFFA_TEAM.Tramo b on a.RECORRIDO_CODIGO = b.RECORRIDO_CODIGO join ZAFFA_TEAM.Puerto c on b.PUERTO_DESDE_ID = c.PUERTO_ID join ZAFFA_TEAM.Puerto d on b.PUERTO_HASTA_ID = d.PUERTO_ID join ZAFFA_TEAM.Recorrido_Unico e on e.RECORRIDO_CODIGO = a.RECORRIDO_CODIGO where d.NOMBRE_PUERTO like '" + PUERTO_DESTINO.Text + "%'  and e.ESTADO_RECORRIDO = 'A' )";
                String d = " order by VIAJE_ID ";
